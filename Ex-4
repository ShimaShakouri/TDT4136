...
"""
Assignment4
Sudoku Solver with Backtracking Search and AC-3
...
class CSP:
    ...
    def backtracking_search(self):
        ...
        # The first time we come to this function, means than we have started to back track, so we'll make the
    ...
    def backtrack(self, assignment):
        ...
        # getting some ideas from this github
        ...
        # for each values in the assignment
        for value in assignment[var]:
            the_assignment = copy.deepcopy(assignment)
            the_assignment[var] = value

            # if it's in the list of legal values
            if self.inference(the_assignment, self.get_all_arcs()):
                # Found inference calling backtrack recursively
                self.backtracking_number += 1
                result = self.backtrack(the_assignment)
                # if the result is successful, return the result
                if result:
                    return result

        # if the result is a failure, increment the number of failed backtracking number
    ...
    def select_unassigned_variable(self, assignment):
        ...
        """
        # for each of the cells, we check the length of possibilities and return the variable
    ...
    def inference(self, assignment, queue):
        ...
        while queue:
            ...
            if self.revise(assignment, i, j):
                if not assignment[i]:
                    return False
                for x, _ in self.get_all_neighboring_arcs(i):
                    if x != j:
                        queue.append((x, i))
        return True
    ...
    def revise(self, assignment, i, j):
        ...
        for x in assignment[i]:
            ...
            if not any(arc in self.constraints[i][j] for arc in arcs):
...
if __name__ == '__main__':
    ...
    txt1 = "\n Number of Backtracking: {}".format(csp.backtracking_number)
    txt2 = "\n Number of Failed Backtracking: {}".format(csp.failed_backtracking_number)
    print(txt1)
    print(txt2)
